        ...
        describe('TestUser', function () {
            ...
            describe('hasMany', function() {
                ...
                describe('hasMany adder', function(){
                    it('should add the id of the phone number to the list of ids', function() {
                ...
                describe('hasMany getter', function() {
                    beforeEach(function() {
                        ...
                        waitsFor(function() {
                            return cb.callCount === 2;
                        });
                    });

                    it('will get phone numbers that are added', function() {
                        user.addPhoneNumber(phoneNumber1);
                        user.addPhoneNumber(phoneNumber2);
                    ...
                    it('will return an empty array if there are no phone numbers', function() {
                        var callback = jasmine.createSpy();
                        user.getPhoneNumbers(callback);
                        waitsFor(function() {
                            return callback.callCount;
